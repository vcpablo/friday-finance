...
import { defineComponent, computed, openBlock, createElementBlock, normalizeClass, unref, renderSlot, createElementVNode, createCommentVNode, h, ref, onMounted, createVNode, Transition, withCtx, createApp, createBlock, toDisplayString, createTextVNode, normalizeStyle, getCurrentInstance } from "vue";
const themes = [
  {
    name: "white",
...
const _hoisted_6$2 = /* @__PURE__ */ createElementVNode("span", { class: "hidden sm:inline-block sm:align-middle sm:h-screen" }, "\xA0", -1);
...
const _hoisted_1 = { class: "rounded-lg shadow-xs overflow-hidden z-100" };
...
const _hoisted_8 = { class: "ml-4 flex-shrink-0 flex mt-0.5" };
const _hoisted_9 = { class: "flex rounded-lg shadow-xs divide-x divide-gray-200 dark:divide-gray-600" };
const _hoisted_10 = { class: "w-0 flex-1 flex items-start p-4" };
const _hoisted_11 = {
  key: 0,
...
const _hoisted_16 = { class: "flex flex-col divide-y divide-gray-200 dark:divide-gray-600" };
const _hoisted_17 = { class: "h-0 flex-1 flex" };
const _hoisted_18 = { class: "h-0 flex-1 flex" };
const _hoisted_19 = { class: "rounded-lg shadow-xs overflow-hidden" };
...
const _hoisted_23 = { class: "w-0 flex-1 flex justify-between" };
const _hoisted_24 = ["innerHTML"];
const _hoisted_25 = { class: "ml-4 flex-shrink-0 flex" };
...
export { _sfc_main$5 as ModalBase, _sfc_main$6 as PushButton, install, useModal, useToast };
